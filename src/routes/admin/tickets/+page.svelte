...
<div class="flex h-full flex-col gap-4 p-6">
	<div class="flex items-center justify-between">
		<div>
			...
			<p class="text-muted-foreground">Manage maintenance and help requests from residents.</p>
		</div>
	</div>
			...
			{:then data}
				<Table.Root>
					...
					<Table.Body>
						...
						{:else}
							<Table.Row>
								<Table.Cell colspan={6} class="h-24 text-center">No tickets found.</Table.Cell>
							</Table.Row>
						{/each}
					</Table.Body>
				</Table.Root>
