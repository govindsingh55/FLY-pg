...
<div class="mx-auto max-w-4xl p-6 space-y-6">
	<div class="flex items-center gap-4">
		...
		<h1 class="text-3xl font-bold tracking-tight">Create Property</h1>
	</div>
	...
	<Card>
		...
		<CardContent>
			...
			>
				{#if createProperty.fields.allIssues()?.length}
					<ul
						class="text-sm text-destructive list-disc list-inside bg-destructive/10 p-4 rounded-md"
					>
