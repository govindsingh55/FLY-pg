...
# FLY-pg: PG/Hostel Management Platform for Working Professionals

## Project Overview
FLY-pg is a platform designed to manage PG/hostel properties for working professionals. It streamlines property management, booking, support, and service workflows for admins, staff, and customers.
...
## Core Features
- Property listing and filtering (location, amenities, price)
- Property detail view (rooms, rent, food info, images)
- Room booking (with/without food), visit scheduling
- Booking management and confirmation by manager
- Support ticket system (manager, chef, cleaning, maintenance)
- Staff management (manager oversees staff roles)
- Daily user check-in/out tracking (security)
- Media management (property images, food menu)

## Customer Experience
Customers can:
- Browse and filter properties by location, amenities, and price
- View detailed property info, available rooms, rent, and food options
- Book rooms (with optional food) or schedule a visit
- Raise support tickets to manager, chef, cleaning, or maintenance staff

## Manager Experience
Managers can:
- View and manage bookings
- Contact and confirm bookings with customers
- Oversee property, staff, rooms, amenities, and food menu

## Required Collections (Payload CMS)
- **Users:** All user types (admin, staff, customer) with role-based access
- **Properties:** Property details, images, amenities, location
- **Index:** Room details, availability, pricing
- **Bookings:** Room/visit bookings, status, customer info
- **Food Menu:** Menu items, pricing, availability
- **Support Tickets:** Linked to customer, staff, type (food, cleaning, maintenance)
- **Staff:** Staff profiles, roles (manager, chef, cleaning, security)
- **Check-in/Check-out Logs:** Daily user movement records

## Auth & Authorization
- Role-based access control for all collections and endpoints
...
- **Frontend:** Next.js, TypeScript, Tailwind CSS (`src/app/(frontend)/`)
- **Backend:** Payload CMS (`src/app/(payload)/`, `src/payload.config.ts`)
